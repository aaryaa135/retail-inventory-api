class TestCreateOrder:
    def test_order_success_deducts_stock(self, client, sample_inventory, sample_product):
        ...
        r = client.post(
            "/api/v1/orders/", json={"items": [{"product_id": sample_product["id"], "quantity": 5}]}
        )
    ...
    def test_insufficient_stock_returns_422(self, client, sample_inventory, sample_product):
        r = client.post(
            "/api/v1/orders/",
            json={"items": [{"product_id": sample_product["id"], "quantity": 9999}]},
        )
    ...
    def test_total_amount_correct(self, client, sample_inventory, sample_product):
        r = client.post(
            "/api/v1/orders/", json={"items": [{"product_id": sample_product["id"], "quantity": 3}]}
        )
...
class TestCancelOrder:
    def test_cancel_restores_stock(self, client, sample_inventory, sample_product):
        ...
        order = client.post(
            "/api/v1/orders/",
            json={"items": [{"product_id": sample_product["id"], "quantity": 10}]},
        ).json()
    ...
    def test_cancel_sets_status(self, client, sample_inventory, sample_product):
        order = client.post(
            "/api/v1/orders/", json={"items": [{"product_id": sample_product["id"], "quantity": 1}]}
        ).json()
...
class TestListOrders:
    ...
    def test_get_order_by_id(self, client, sample_inventory, sample_product):
        order = client.post(
            "/api/v1/orders/", json={"items": [{"product_id": sample_product["id"], "quantity": 2}]}
        ).json()
